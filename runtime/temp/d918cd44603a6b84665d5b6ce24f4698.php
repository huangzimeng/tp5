<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\www\tp\public/../application/admin/view/default/repair\edit.html";i:1526194419;s:67:"D:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">地址<span class="check-tips"></span></label>
			<div class="controls">
				<textarea name="content" id="container" cols="30" rows="10"><?php echo (isset($info['address']) && ($info['address'] !== '')?$info['address']:''); ?></textarea>
			</div>
		</div>
		<div class="form-item">
			<div class="controls">
